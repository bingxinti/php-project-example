...
class W2Array {
	...
	public static function objectToArr($array)
	{
		$json = Utility::jsonEncode($array);
		$arr  = Utility::jsonDecode($json);
		return $arr;
	}
	...
	public static function objToArray($array)
	{
		return json_decode(Utility::json_encode_unicode($array), true);
	}
