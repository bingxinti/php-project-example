...
class ApiTestHandler extends BaseHandler
{
    ...
    /**
     * 根据主键值查询单条记录
     * @return ApiTestModel 对应的model 实例
     */
    ...
    * @return ApiTestModel[]        对应的model 实例数组
    */
     ...
     * @return ApiTestModel         返回更新后的模型对象
     */
